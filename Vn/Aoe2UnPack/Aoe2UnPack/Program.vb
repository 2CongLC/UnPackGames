...
Module Program
        ...
        If IO.File.Exists(input) Then
            ...
            For i As Int32 = 0 To tablecount - 1
                ...
                For Each td As TableData In subtables
                    Console.WriteLine("Extension : {0} -  File Offset : {1} - Num Of Files : {2} ", td.name, td.offset, td.totalfiles)
                    For j As Int32 = 0 To td.totalfiles - 1
                        subfiles.Add(
                             New FileData
                         )
                    Next
    ...
    Class TableData
        ...
        Public Sub New()
            name = Encoding.GetEncoding("us-ascii").GetString(br.ReadBytes(4))
            offset = br.ReadInt32
