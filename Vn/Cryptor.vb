Module Cryptors
    ...
    Public Sub EDOneTimePad_Encipher(ByRef pPlaintext As Char(), ByVal nPlainLen As Integer)
    ...
    Public Sub EDOneTimePad_Decipher(ByRef pCiphertext As Char(), ByVal nCiphertextLen As Integer)
